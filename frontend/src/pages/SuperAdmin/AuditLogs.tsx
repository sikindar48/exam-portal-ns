              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50">
                    <th className="py-4 px-6 text-[10px] font-black uppercase tracking-widest">Admin User</th>
                    <th className="py-4 px-6 text-[10px] font-black uppercase tracking-widest">Action</th>
                    <th className="py-4 px-6 text-[10px] font-black uppercase tracking-widest">Entity</th>
                    <th className="py-4 px-6 text-[10px] font-black uppercase tracking-widest">ID</th>
                    <th className="py-4 px-6 text-[10px] font-black uppercase tracking-widest">Timestamp</th>
                    <th className="py-4 px-6 text-[10px] font-black uppercase tracking-widest text-right">Details</th>
                  </tr>
                </thead>
                <tbody>
                  {loading ? (
                    ...
                    logs.map((log) => (
                      <tr key={log.id} className="border-b border-slate-100 dark:border-slate-900 hover:bg-slate-50 dark:hover:bg-slate-900/30 transition-all">
                        ...
                        <td className="py-4 px-6 text-xs text-slate-700 dark:text-slate-300 font-bold">
                          {log.action}
                        </td>
                        <td className="py-4 px-6 text-xs font-black uppercase tracking-widest text-slate-500">
                          {log.entity_type.replace(/_/g, " ")}
                        </td>
                        <td className="py-4 px-6 text-xs font-mono text-slate-400 truncate max-w-[120px]">
                          {log.entity_id}
                        </td>
