...
export default function PackageSelection() {
  ...
  const handleBuyPackageRazorpay = async (pkg: any) => {
    if (!clientId || payingPackageId !== null || requestingPackageId !== null) return;
      ...
      await initiateRazorpayPayment({
        ...
        onSuccess: () => {
          toast({
            ...
            description: `Assessment credit for ${pkg.name} has been added to your inventory.`,
          });
          fetchPackagesData();
