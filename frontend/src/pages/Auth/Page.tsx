        ...
        <div className="flex-1 flex flex-col justify-center items-center px-4 pb-12 sm:px-6 lg:px-8">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="signin" className="space-y-3 sm:space-y-4">
              {/* Google Button */}
              <Button onClick={handleGoogleSignIn} disabled={loading} className="w-full h-11 border-2 text-sm" variant="outline">
              ...
              {/* Guest Button */}
              <Button onClick={handleAnonymousSignIn} disabled={loading} className="w-full h-11 border-2 text-sm" variant="outline">
            ...
            <TabsContent value="signup" className="space-y-3 sm:space-y-4">
              ...
              <div className="hidden sm:block">
                <Button onClick={handleGoogleSignIn} disabled={loading} className="w-full h-11 border-2 text-sm mb-3" variant="outline">
                  <svg className="h-4 w-4 mr-2" viewBox="0 0 24 24">
                    <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
                    <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
                    <path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z"/>
              ...
              <form onSubmit={handleSignUp} className="space-y-3 sm:space-y-4">
                ...
                <Button type="submit" disabled={loading || !selectedClient} className="w-full h-11 text-sm font-semibold mt-2">
